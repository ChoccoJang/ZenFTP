...
function activate(context) {
    ...
    // treeview 생성
    vscode.window.createTreeView('ZenFTPServers', { treeDataProvider: serverProvider })
    vscode.window.createTreeView('ZenFTPFiles', { treeDataProvider: fileProvider })
    ...
    context.subscriptions.push(
        ...
        // -- 파일/폴더
        vscode.commands.registerCommand('ZenFTP.openFile', (fileNode) => fileProvider.openFile(fileNode)),
